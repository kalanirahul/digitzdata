      ...
      [SHEETS.webinars]: [
        {
          ...
          description: 'This is demo data. Short card description shown on the events listing page.',
          fullDescription: 'This is a comprehensive demonstration webinar showcasing the capabilities of the DD Consulting events platform. Join us for an in-depth session covering modern actuarial techniques and their practical applications in the GCC insurance market.',
          agenda: 'Welcome & Introduction|Core Concepts Overview|Live Demonstration|Interactive Q&A Session|Wrap-up & Next Steps',
          agendaDetails: '',
          keyTakeaways: 'Understanding of core actuarial methods|Practical tools for daily work|Industry best practices|Networking opportunities',
          targetAudience: 'Actuarial professionals, insurance executives, risk managers, and anyone interested in modern actuarial approaches.',
          prerequisites: 'Basic understanding of insurance concepts recommended.',
          eventType: 'Webinar',
          duration: '90 minutes',
          location: 'Online',
          price: 'Free',
          bannerImage: '',
          tags: 'Actuarial|Insurance|Demo',
          cpdCredits: '1.5 CPD Hours',
          featured: 'true',
          status: 'upcoming',
          registerLink: '#',
          recordingLink: ''
